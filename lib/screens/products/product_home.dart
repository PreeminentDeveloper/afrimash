...
class ProductViewState extends State<ProductView> {
  ...
  dialogBox(String content, Function onPressed) {
    showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            ...
            body: Container(
              child: SingleChildScrollView(
                ...
                Container(
                  ...
                  children: [
                    Text('Trending Products', style: Constants.headerStyle),
                    InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                ...
                Container(
                    ...
                    child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemCount:
                            trendingProductService.trendingProduct.length ?? 0,
                        itemBuilder: (BuildContext context, int index) {
                          var trendingProduct =
                ...
                Container(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Featured Products', style: Constants.headerStyle),
                    InkWell(
                        onTap: () {
